...
public class WalkthroughActivity extends AppCompatActivity {
    ...
    private void setupWalkthroughItems() {
        ...
        itemWalkthrough1.setTitle("Hi!");
        itemWalkthrough1.setSubtitle("Welcome to RIFQI APPS");
        itemWalkthrough1.setImage(R.drawable.walkthrough1);

        WalkthroughModel itemWalkthrough2 = new WalkthroughModel();
        itemWalkthrough2.setTitle("What's in this app?");
        itemWalkthrough2.setSubtitle("My profile, activity, gallery, friends, music and videos are all here");
        ...
        itemWalkthrough3.setSubtitle("My contact information is here, contact me if you want");
